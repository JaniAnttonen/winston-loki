...
### Latest
The latest version, which might not be fully tested, but should be compatible with the latest Grafana Loki, is `6.0.0-rc.8`. It is recommended to use this one if you're using the latest version of Loki. _Last tested working with Loki 1.4.1_
